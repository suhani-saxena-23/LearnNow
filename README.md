# [LearnNow - EdTech Platform](https://LearnNow-seven-nu.vercel.app/)

LearnNow is a fully functional EdTech platform that enables users to create, consume, and rate educational content. The platform is built using the MERN stack, which includes ReactJS, NodeJS, MongoDB, and ExpressJS.
...
LearnNow aims to provide a seamless and interactive learning experience for students, making education more accessible and engaging. Additionally, the platform serves as a platform for instructors to showcase their expertise and connect with learners across the globe.

## System Architecture

The LearnNow EdTech platform consists of three main components: the front-end, the back-end, and the database. The platform follows a client-server architecture, with the front-end serving as the client and the back-end and database serving as the server.

### Front-end

The front end of LearnNow has all the necessary pages that an ed-tech platform should have. Some of these pages are:
...
The back end of LearnNow provides a range of features and functionalities, including:
...
- **Cloud-based media management**: LearnNow uses Cloudinary, a cloud-based media management service, to store and manage all media content, including images, videos, and documents.
- **Markdown formatting**: Course content in document format is stored in Markdown format, which allows for easier display and rendering on the front end.

### API Design

The LearnNow platform's API is designed following the REST architectural style. The API is implemented using Node.js and Express.js. It uses JSON for data exchange and follows standard HTTP request methods such as GET, POST, PUT, and DELETE.

## Installation

To install the LearnNow platform, follow these steps:

- Clone the repository: `git clone https://github.com/ash956901/LearnNow`
- Navigate to the project directory: `cd LearnNow`
...
The LearnNow platform relies on the following dependencies:
